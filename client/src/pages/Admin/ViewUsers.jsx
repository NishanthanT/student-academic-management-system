  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-8 duration-700 ease-out pb-20">
      ...
      <section className="bg-white/60 dark:bg-gray-800/60 backdrop-blur-2xl rounded-[2.5rem] shadow-2xl border-2 border-white/20 dark:border-gray-700/30 p-8 overflow-hidden">
        ...
        <div className="border-2 border-gray-100 dark:border-gray-700/50 rounded-[2rem] overflow-hidden bg-white/30 dark:bg-gray-900/30 transition-all">
        ...
        >
          ...
          <div className="flex gap-4">
            ...
            <button
              ...
              className="flex-1 py-4 rounded-2xl bg-red-600 text-white font-black uppercase text-xs tracking-widest shadow-xl shadow-red-500/20 hover:bg-red-700 hover:-translate-y-1 transition-all"
            >
              Delete
            </button>
          </div>
