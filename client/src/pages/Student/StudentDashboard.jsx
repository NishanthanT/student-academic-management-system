  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 flex transition-colors duration-300 font-sans">
      ...
      <aside className="w-72 bg-gray-100/80 dark:bg-gray-900/80 backdrop-blur-xl border-r border-gray-200 dark:border-gray-800 h-screen sticky top-0 px-6 py-8 shadow-xl flex flex-col z-20">
        ...
        <nav className="space-y-3 flex-1 overflow-y-auto pr-2 custom-scrollbar text-sm">
      ...
      <main className="flex-1 h-screen overflow-hidden flex flex-col bg-gray-50/30 dark:bg-gray-950/30">
        ...
        {/* Sticky Header */}
        <header className="sticky top-0 z-30 w-full bg-gray-50 dark:bg-gray-950 px-10 pt-10 pb-6 border-b border-gray-200/50 dark:border-gray-800/50 transition-colors duration-500">
          <div className="bg-white dark:bg-gray-900 rounded-[2rem] shadow-2xl border dark:border-gray-800 p-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 transition-all duration-500 hover:shadow-indigo-500/5">
            <div>
              ...
              <p className="text-sm font-bold text-gray-500 dark:text-gray-400 mt-1">
                 Your academic focus for today: Keep pushing forward!
              </p>
            </div>
            ...
            <div className="flex items-center gap-4 bg-gray-50 dark:bg-gray-800/50 px-5 py-3 rounded-2xl border dark:border-gray-800">
               ...
               <div>
                  ...
                  <div className="text-sm font-black text-gray-800 dark:text-gray-200 capitalize">Student Portal</div>
               </div>
            </div>
          </div>
        </header>
