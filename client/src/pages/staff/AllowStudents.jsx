        ...
        <div className="as-modal__body">
          ...
          <div className="as-card" style={{ marginTop: 12 }} id="ms_allowed_students_card">
            ...
            <div className="as-muted" style={{ marginTop: 10 }} id="ms_footer_hint">
              Tip: Approve All Want password set.
            </div>
          </div>
        </div>
  ...
  return (
    <div className="as-page">
      <style>{`
        ...
        .dark .as-input { background: #111827 !important; border-color: #374151 !important; color: #f3f4f6 !important; }
        .dark .as-input::placeholder { color: #6b7280; }
        /* Fix for Webkit autofill backgrounds */
        .dark .as-input:-webkit-autofill,
        .dark .as-input:-webkit-autofill:hover,
        .dark .as-input:-webkit-autofill:focus {
