...
export default function StaffExams() {
  ...
  const [from, setFrom] = useState(""); // Default NO date filter
  const [to, setTo] = useState("");     // Default NO date filter
  ...
  const onTab = (t) => {
    ...
    setQ("");
    setSubjectId("all");
    // ✅ Note: No longer resetting dates to Today-30 to ensure all exams stay visible
  };
  ...
  return (
    <div className="sx-page">
      <style>{`
        ...
        .sx-btn--danger{background:#fff1f2;border-color:#fecdd3;color:#be123c}
        .sx-btn--success{background:#f0fdf4;border-color:#bbf7d0;color:#15803d}
        .sx-btn--warning{background:#fffbeb;border-color:#fde68a;color:#b45309}
        .sx-btn--edit{background:#f5f3ff;border-color:#ddd6fe;color:#6d28d9}
        .sx-btn--info{background:#f0f9ff;border-color:#bae6fd;color:#0369a1}
      ...
      {loading ? (
        ...
        <div className="sx-empty">
          ...
          <div className="sx-muted" style={{ marginBottom: 14 }}>
            Tip: If data is missing, check your date filters above. Click 'Clear All Filters' to see your complete history.
          </div>
                  ...
                  return (
                    <tr key={x.id}>
                      <td>
                        ...
                        <div className="sx-muted" style={{ fontSize: "11px", marginTop: "4px" }}>
                          BY: {x.is_creator ? "You" : x.creator_name || "Unknown Staff"}
                        </div>
                        {x._admin_note ? (
                      ...
                      <td>
                        <div className="sx-actions-col">
                          {/* If NOT creator, only show View button */}
                          {!x.is_creator ? (
                            <button
                              className="sx-btn sx-btn--info"
                              onClick={() => openEdit(x)}
                              disabled={busy}
                            ...
                            <>
                              {/* Creator Actions Grouped Logically */}
                              <div style={{ display: "flex", gap: "8px", width: "100%", flexWrap: "wrap" }}>
                                <button
                                  className={`sx-btn ${descOk && !editOk ? "sx-btn--info" : "sx-btn--edit"}`}
                                  onClick={() => openEdit(x)}
                                ...
                                {submitOk && (
                                  <button
                                    className="sx-btn sx-btn--success"
                                ...
                                {resubmitOk && (
                                  <button
                                    className="sx-btn sx-btn--warning"
