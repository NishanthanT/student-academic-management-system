    ...
    <div style={sx.page}>
      ...
      <div style={sx.headCard}>
        <div>
          ...
          <div style={sx.hSub}>
            Subject filter + Exam select + Student Email filter. ABSENT → AB. PASS/FAIL auto.
          </div>
        </div>
      ...
      <div style={sx.card}>
        ...
        <div style={sx.note}>
          Auto-correct: Exam select → tries <code>/staff/exams/:examId/auto-grade</code> (optional),
          then loads <code>/staff/exams/:examId/results</code>. Absent: AB rows edit disabled.
        </div>
      </div>
