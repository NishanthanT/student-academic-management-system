...
export default function StaffLayout() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 flex transition-colors duration-300 font-sans">
      ...
      {/* Main Container - Controlled Scroll */}
      <main className="flex-1 h-screen overflow-hidden flex flex-col bg-gray-50/30 dark:bg-gray-950/30">

        {/* Superior Topbar - Perfectly Fixed at top of main */}
        <div className="sticky top-0 z-30 w-full bg-gray-50 dark:bg-gray-950 px-4 md:px-10 pt-4 md:pt-10 pb-4 md:pb-6 border-b border-gray-200/50 dark:border-gray-800/50 transition-colors duration-500">
          <div className="bg-white dark:bg-gray-900 rounded-2xl md:rounded-[1.5rem] shadow-xl border dark:border-gray-800 p-4 md:p-6 flex flex-col md:flex-row items-center justify-between gap-4 transition-all duration-500">
            ...
            <div className="flex items-center gap-4 bg-gray-50 dark:bg-gray-800/50 px-5 py-3 rounded-2xl border dark:border-gray-800 scale-90 md:scale-100">
              ...
              <div>
                ...
                <div className="text-sm font-black text-gray-800 dark:text-gray-200 capitalize">{role}</div>
              </div>
            </div>
          </div>
        </div>
