...
/* =========================
   ...
   - /exams/:examId/results/details gives granular question answers
   - /exams/:examId/analysis gives stats and performance distribution
 ========================= */
...
// 5) Detailed attempt results (Specific Student)
router.get("/exams/:examId/results/:studentId/details", staffResults.getAttemptDetails);

// 6) Exam Analysis (Stats + Distribution)
router.get("/exams/:examId/analysis", staffResults.getExamAnalysis);
